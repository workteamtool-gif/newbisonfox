export function translateErrorReason(reason: string): string {
  ...
  if (
    lowerReason.includes('ebusy') ||
    lowerReason.includes('locked') ||
    lowerReason.includes('in use')
  ) {
  ...
  if (
    lowerReason.includes('emfile') ||
    lowerReason.includes('enfile') ||
    lowerReason.includes('too many open files')
  ) {
